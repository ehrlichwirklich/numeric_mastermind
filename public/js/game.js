document.getElementById("guess").addEventListener("change", (event) => {validate(event, "guess", "ghint", "../src/auth.php" )});
document.getElementById("game").addEventListener('submit', (event) => {validate(event, "game","ghint", "" )});
